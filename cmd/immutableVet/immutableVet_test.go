...
_testFiles/test.go:13:2: immutable struct field must be immutable type; github.com/myitcv/immutable/cmd/immutableVet/_testFiles.MyType is not
_testFiles/test.go:20:6: type should be *github.com/myitcv/immutable/cmd/immutableVet/_testFiles.Dummy
_testFiles/test.go:24:7: template type github.com/myitcv/immutable/cmd/immutableVet/_testFiles._Imm_Dummy should never get used
_testFiles/test.go:25:5: type should be *github.com/myitcv/immutable/cmd/immutableVet/_testFiles.Dummy
_testFiles/test.go:27:7: type should be *github.com/myitcv/immutable/cmd/immutableVet/_testFiles.Dummy
_testFiles/test.go:28:7: type should be *github.com/myitcv/immutable/cmd/immutableVet/_testFiles.Dummy
...
`
	...
	specs := gotool.ImportPaths([]string{
		"github.com/myitcv/immutable/cmd/immutableVet/_testFiles",
	})
